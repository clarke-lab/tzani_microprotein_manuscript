...
samples = { K : pd.read_table("differential_translation/gene_cds_counts/%s.txt" % K,sep="\t",header=0,comment="#",index_col=None) for K in sample_names }
...
# save
combined_df.to_csv("differential_translation/gene_cds_counts.txt",sep="\t",header=True,index=False,
