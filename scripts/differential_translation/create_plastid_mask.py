...
transcript_reader = GTF2_TranscriptAssembler(open("differential_translation/plastid_reference/extended_orf_annotation.gtf"))
fout_start = open("differential_translation/plastid_reference/start_codon_masks.bed","w")
fout_stop = open("differential_translation/plastid_reference/stop_codon_masks.bed","w")
